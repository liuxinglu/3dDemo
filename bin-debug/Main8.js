...
var Main8 = (function (_super) {
    ...
    Main8.prototype.startVideo = function () {
        // super.startVideo();
    ...
    Main8.prototype.loadAssets = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var loading, path, resources, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
...
Main8 = __decorate([
    RES.mapConfig("config.json", function () { return getURL() + "resource"; }, function (path) {
